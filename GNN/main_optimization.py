...
if __name__ == "__main__":
    ...
    for encoding in encodings_list:
        ...
        for model_type in ["GINEModel", "GENModel", "GATModel"]:
            ...
            study.optimize(
                lambda trial: objective_names[model_type](trial, train_list, verbose=0, max_degree=max_degree),
    ...
    # save
    plt.savefig(
        result_analysis_folder + "encodings_and_models_comparison.png"
    )
    ...
    plt.savefig(result_analysis_folder+"predictions_histograms.png")
    ...
    plt.savefig(result_analysis_folder+"predictions_scatter.png")
